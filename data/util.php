...
<div id=\"shl-dialogue-container-$id\" class=\"dialogue-bg\" style=\"display: none; position: fixed; top: 0; left: 0; width: 100vw; height: 100vh; background: #000c; z-index: 1000;\">
	<div class=\"dialogue-surface\" style=\"position: relative; top: 50%; left: 50%; transform: translate(-50%, -50%); width: max(50vw, 20em); height: $height; background: var(--colour-background); border-radius: 0.5em; box-shadow: 0 0.3em 0.4em var(--colour-background-dark-b); padding: 1.0em;\">
